...
<template>
  <v-card :loading='loading' class='mx-auto my-12' elevation='4' max-width='374' @click='setTimeout(()=> {}, 0)'>
    ...
    <v-card-actions class='v-card-actions'>
      <v-btn class='v-btn' color='primary' prepend-icon='mdi-calendar-clock' rounded='pill' variant='flat'
             @click='reserve'>
        Reservar
      </v-btn>
    </v-card-actions>
