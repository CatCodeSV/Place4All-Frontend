    ...
    <v-card>
      ...
      <div class='d-flex pa-4 w-100 bg-white flex-wrap'>
        ...
        <v-btn
          ...
          @click='isEdit = !isEdit' />
        <v-btn color='primary' rounded='pill' prepend-icon='mdi-calendar-clock' class='w-80 my-4' @click='reserve'>
          Reservar
        </v-btn>
      </div>
      <v-divider />
              ...
              <v-col cols='12' lg='4' md='6' sm='12' v-for='(review, index) in reviews' :key='index'>
                <v-card outlined color='transparent' :border='0' :density="'compact'" height='250px' :elevation='5'>
                  <v-card-item>
                    ...
                    <v-rating :model-value='review.value' color='amber' density='compact' half-increments readonly
                              size='small' />
                  </v-card-item>
                  <v-card-text>
